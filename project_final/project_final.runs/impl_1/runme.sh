...
HD_PWD='C:/Users/ege3b/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor.tcl -notrace
