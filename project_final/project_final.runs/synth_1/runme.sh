...
HD_PWD='C:/Users/ege3b/project_final/project_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor.tcl
